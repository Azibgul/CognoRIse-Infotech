  ...
  return (
    <div className='w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b]  p-4 lgl:p-8 
        ...
        <div className="flex flex-col gap-4">
            <h3 className="text-3xl font-bold text-white">Azib Gul</h3>
            <p className="text-lg font-normal text-gray-400">
            FrontEnd WEb Developer
            </p>
            <p className="text-base text-gray-400 tracking-wide">
            I an innovative Experienced Frontend web Developer with a strong
            command of HTML, CSS, and JavaScript, ReactJS
            </p>
            <p className="text-base text-gray-400 flex items-center gap-2">
            Phone: <span className="text-lightText">+92 3410538240</span>
            </p>
            <p className="text-base text-gray-400 flex items-center gap-2">
            Email: <span className="text-lightText">azibgull1234@gmail.com</span>
            </p>
      </div>
      <div className="flex flex-col gap-4">
