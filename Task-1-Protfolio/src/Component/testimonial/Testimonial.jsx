...
function SampleNextArrow(props) {
  ...
  return (
    ...
    rounded-md text-2xl text-gray-400 flex justify-center items-center absolute top-0 
  ...
  return (
    <section id="testimonial" className="w-full py-20 border-b-[1px] border-b-black">
      ...
      <div className='w-full'>
        ...
        rounded-lg shadow-shadowOne flex flex-col md:flex-row lgl:flex-col gap-8 
        ...
        <div className='w-full h-[70%] bg-gradient-to-r from-[#1e2024] to-[#23272b]  p-4 lgl:p-8 
        rounded-lg shadow-shadowOne flex flex-col justify-center gap-4 lgl:gap-8'>
